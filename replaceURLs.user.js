...
(function() {
  ...
  header.insertAdjacentHTML('button id="save_settings" class="button-1" style="width: 120px; height: 30px; font-size: 14px; padding: 0px; margin-right: 15px;">Save</button>');
